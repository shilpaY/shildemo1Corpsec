...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>SendDataUsingRESTAPI</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SendIncidentUsingRESTAPI</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <classAccesses>
        <apexClass>caseFormController</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>clsSubmitDatainOtherOrg</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
        <editable>true</editable>
        <field>IncidentObj__c.CaseId__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>IncidentObj__c.caseOrigin__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>IncidentObj__c-IncidentObj Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>caseFormVF</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>sendDataUsingRestAPIPage</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <tabVisibilities>
        <tab>IncidentObj__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
        <tab>caseCreationForm</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
        <tab>spikeToDisplayWebApp</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
